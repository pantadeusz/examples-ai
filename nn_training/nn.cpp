...
vector<matrix_t> nn_randomize(const vector<matrix_t> &nn,
                              double range_min = -10, double range_max = 10) {
  auto m = nn;
...
vector<matrix_t> training_nn(vector<matrix_t> m, vector<vector_t> a,
                             function<double(double)> activation_function,
                             string training_set, int iterations) {
...
void verify_nn(vector<matrix_t> m, vector<vector_t> a,
               function<double(double)> activation_function,
               string training_set, string save_graphviz = "") {
